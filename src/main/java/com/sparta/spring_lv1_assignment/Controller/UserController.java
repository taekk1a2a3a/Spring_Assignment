...
public class UserController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<StatusMessageDto> signup(@RequestBody @Valid SignupRequestDto signupRequestDto) {
        return userService.signup(signupRequestDto);
    }

    @ResponseBody //ajax 에서 body 쪽에 값이 넘어오기 때문에 @RequestBody 를 써줘야 한다.
    @PostMapping("/login")
    public ResponseEntity<StatusMessageDto> login(@RequestBody LoginRequestDto loginRequestDto, HttpServletResponse response) {
